...
function injectSessionClient(html) {
  if (html.includes('session-client.js')) return html;
  return html.replace('</head>', '  <script src="/js/session-client.js"></script>\n</head>');
}
...
function renderPage(pageName) {
  ...
  return injectSessionClient(html);
}
