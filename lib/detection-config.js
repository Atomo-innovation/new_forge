const TABS = {
  ...
  face: {
    ...
    featureOptions: [
      { id: 'faceDetect', label: 'Detect faces', description: 'Core face detection on every frame', locked: true },
      { id: 'countFaces', label: 'Count faces', description: 'Live face count across assigned camera feeds' },
      { id: 'boundingBoxes', label: 'Show bounding boxes', description: 'Draw detection boxes on stream preview and snapshots' },
      { id: 'knownRecognition', label: 'Known face recognition', description: 'Match detected faces against the enrolled database' },
      { id: 'unknownDetect', label: 'Unknown face alerts', description: 'Flag faces that are not in the enrolled database' },
    ],
    alertOptions: [
